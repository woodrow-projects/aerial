...
/**
 * Presentational table primitive (shadcn Table surface) — used by the playlists
 * and clocks lists. Purely structural styling over native table elements; wraps in
 * a horizontally scrollable container so wide rows never push the page sideways.
 * Consumes theme tokens only (no raw colours).
 */
